...
{
    [Obsolete]
    public class MainWalkerOnZen_obsolete : ServicesDataAndComponents_obsolete
    {
        ...
        private InstanceSettings_obsolete.Obsolete_BusySettings _individualStateBusy;
        ...
        /// </summary>
        public MainWalkerOnZen_obsolete(ObjectTypeEnum resourceTypeAtWork)
        {
            SetSettingsMode();
        ...
        /// </summary>
        public MainWalkerOnZen_obsolete()
        {
        ...
        private void SetSettingsMode()
        {
            ...
            _individualStateBusy = InstanceSettings_obsolete.Obsolete_BusySettings.ExtractBusySettingsFromVariable(Zenno.Variables["cfgPolicyOfIgnoringForWalkingOnZen"].Value);
        ...
        private void GoToWalki()
        {
            ...
            while (true)
            {
                ...
                if (_useAuthorizationForAccounts && CurrentObjectAtWork == ObjectTypeEnum.Account && Instance.FindFirstElement(xpathAvatarProfile, false, false).IsNullOrVoid())
                {
        ...
        private bool ActionOpenItem(HtmlElement item, int itemNumb)
        {
            ...
            if (_individualStateBusyEnabled)
                InstanceSettings_obsolete.Obsolete_BusySettings.SetBusySettings(_individualStateBusy);
