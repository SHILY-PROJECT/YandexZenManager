...
using Yandex.Zen.Core.Services.BrowserAccountManagerService.Components;

namespace Yandex.Zen.Core.Services.BrowserAccountManagerService
{
    [Obsolete]
    public class MainBrowserAccountManager_obsolete : ServicesDataAndComponents_obsolete
    {
        ...
        /// </summary>
        public MainBrowserAccountManager_obsolete()
        {
