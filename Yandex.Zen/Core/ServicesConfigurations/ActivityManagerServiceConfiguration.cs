...
{
    public sealed class ActivityManagerServiceConfiguration : BaseAccountConfiguration, IServiceConfiguration
    {
        public ActivityManagerServiceConfiguration(IDataManager manager) : base(manager)
        {
