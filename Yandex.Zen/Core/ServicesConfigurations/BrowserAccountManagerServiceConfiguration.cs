...
{
    public sealed class BrowserAccountManagerServiceConfiguration : BaseAccountConfiguration, IServiceConfiguration
    {
        public BrowserAccountManagerServiceConfiguration(IDataManager manager) : base(manager)
        {
