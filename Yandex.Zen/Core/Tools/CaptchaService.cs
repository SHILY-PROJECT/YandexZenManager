...
{
    public class CaptchaService : ServiceComponents
    {
        /// <summary>
        ...
        public static string Recognize(HtmlElement htmlElementImgCaptcha)
        {
            ...
            try
            {
                ...
                var responseCaptcha = ZennoPoster.CaptchaRecognition(Program.CaptchaServiceDll, Convert.ToBase64String(btImg), "");
