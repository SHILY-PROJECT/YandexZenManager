...
using Yandex.Zen.Core.Services.ChannelHandlerService.Enums;
using Yandex.Zen.Core.Services.ChannelHandlerService.Models.ChannelSettings.DataModels;
using Yandex.Zen.Core.Services.Components;
using Yandex.Zen.Core.Toolkit.BrowserCustomizer;
using Yandex.Zen.Core.Toolkit.BrowserCustomizer.Enums;

namespace Yandex.Zen.Core.Services.ChannelHandlerService
{
    public class ChannelHandler : ServicesDataAndComponents
    {
        ...
        public ChannelHandler(bool createAnEmptyConstructor) => SetSettingsMode();
